const e=`## Tier 1 Safe/Combination Locks
...
- Yale V705 padlock
`,o=`## Tier 3 Submission Example - Lady Locks
...
**Lady Locks** 
`,t=`Attention all lockpicking enthusiasts, tinkerers, and masters of the craft! We are thrilled to unveil a bold new tradition in our ranking system—from this day forward, all lockpicking belts will be shades of pink! 🎀✨
...
`,i=`There are special cases in which the Dan Point value for a lock is modified to reflect the amount of work and skill that was required to open it. Achievements below apply a specific multipler to the normal Dan points for the lock as ranked.
...
`,a={safeLocksTierOne:{title:"Tier 1 Safe/Combination Locks",content:e},tierThreeExample:{title:"Tier 3 Submission Example",content:o},pinkBelts:{title:"Official Announcement: The Pink Belt Revolution!",content:t},classificationProcess:{title:"Lockpickers United Belt Ranking Process",content:n},danModifiers:{title:"Dan System - Point Modifiers",content:i}};export{a as p};
