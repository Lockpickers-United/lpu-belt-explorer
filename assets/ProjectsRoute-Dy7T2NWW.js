import{a as e}from"./rolldown-runtime-B0Z9INg1.js";import{ot as t,q as n}from"./utils-BBPQSqcU.js";import{t as r}from"./Nav-BKJq8I3l.js";import{s as i}from"./chunk-OB3PAWPO-CPAqtvhR.js";import{t as a}from"./Card-C0FF6KFj.js";import{t as o}from"./CardContent-D_QNgda_.js";import{t as s}from"./Footer-BdbSo7JS.js";import{t as c}from"./Link-ufojjnK9.js";import{n as l,t as u}from"./FilterContext-B_sM3kUO.js";import{t as d}from"./Tracker-BW9lLf8u.js";import{t as f}from"./usePageTitle-C76MYlQv.js";import{t as p}from"./lib-B0vP4FHO.js";import{t as m}from"./lib-DbE6SaL9.js";import{t as h}from"./filterFields-C1LJTrum.js";import{t as g}from"./lib-Bq6O4Dg4.js";/* empty css                  */var _=e(t(),1),v=`You can also nominate others to receive points through:
...
Dan Points can be earned by completing projects within the following Disciplines:`,b=n();function x(){let e=i(),{filters:t}=(0,_.useContext)(u),n=t?.id,r=(0,_.useCallback)(t=>{e(`/projects?id=${t}`)},[e]),s=e=>{let t=document.getElementById(e);window.scrollTo({left:0,top:t.offsetTop-75,behavior:`smooth`})};(0,_.useEffect)(()=>{n&&document.getElementById(n)&&s(n)},[n]);let l={"Case Making Project Guidelines":`case-making-project-guidelines`,"Challenge Lock Making":`challenge-lock-making`,"Community Involvement":`community-involvement`,"Cutaway Making":`cutaway-making`,"Disc Detainer Pick Making":`disc-detainer-pick-making`,Impressioning:`impressioning`,"Pick Making":`pick-making`,"Safe Lock Manipulation":`safe-lock-manipulation`,"Tool Making":`tool-making`,"Other Approved Projects":`other-approved-projects`},d=[`Case Making Project Guidelines`,`Challenge Lock Making`,`Community Involvement`,`Cutaway Making`,`Disc Detainer Pick Making`,`Impressioning`,`Lock Design`,`Lock Manufacturing`,`Pick Making`,`Picking Instruction`,`Safe Lock Manipulation`,`Tool Making`,`Tool Manufacturing`,`Other Approved Projects`].map(e=>{let t=l[e];return(0,b.jsx)(`li`,{style:{marginTop:2},children:t?(0,b.jsx)(c,{onClick:()=>r(t),style:{color:`#fff`,textDecorationColor:`#aaa`,cursor:`pointer`,fontWeight:500},children:e}):(0,b.jsx)(`div`,{style:{color:`#fff`,fontWeight:400},children:e})},e)});return(0,b.jsx)(_.Fragment,{children:(0,b.jsx)(a,{style:{maxWidth:800,marginLeft:`auto`,marginRight:`auto`,marginTop:16,marginBottom:16,padding:`0px 30px`},children:(0,b.jsxs)(o,{children:[(0,b.jsx)(p,{rehypePlugins:[[m,{target:`_blank`,rel:[`nofollow`,`noopener`,`noreferrer`]}]],remarkPlugins:[g],children:String(y)}),(0,b.jsx)(`ul`,{children:d}),(0,b.jsx)(({content:e})=>(0,b.jsx)(p,{remarkPlugins:[g],rehypePlugins:[[m,{target:`_blank`,rel:[`nofollow`,`noopener`,`noreferrer`]}]],components:{h1:({node:e,...t})=>(0,b.jsx)(`h1`,{id:e.children[0].value.toLowerCase().replace(/ /g,`-`),...t}),h2:({node:e,...t})=>(0,b.jsx)(`h2`,{id:e.children[0].value.toLowerCase().replace(/ /g,`-`),...t}),h3:({node:e,...t})=>(0,b.jsx)(`h3`,{id:e.children[0].value.toLowerCase().replace(/ /g,`-`),...t}),h4:({node:e,...t})=>(0,b.jsx)(`h4`,{id:e.children[0].value.toLowerCase().replace(/ /g,`-`),...t}),h5:({node:e,...t})=>(0,b.jsx)(`h5`,{id:e.children[0].value.toLowerCase().replace(/ /g,`-`),...t}),h6:({node:e,...t})=>(0,b.jsx)(`h6`,{id:e.children[0].value.toLowerCase().replace(/ /g,`-`),...t})},children:e}),{content:v})]})})})}function S(){return f(`Master's Projects`),(0,b.jsxs)(l,{filterFields:h,children:[(0,b.jsx)(r,{title:`Master's Projects`}),(0,b.jsx)(x,{}),(0,b.jsx)(s,{}),(0,b.jsx)(d,{feature:`projects`})]})}export{S as default};