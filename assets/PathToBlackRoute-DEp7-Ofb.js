import{b as B,r as j,j as e,R as l,u as S,ah as M,ai as D,e as O,a2 as U,N as C,h as z,T as q}from"./index-OScSG1m8.js";import{u as _}from"./usePageTitle-DgssInEJ.js";import{B as F}from"./BeltStripeMini-CJlsakm6.js";import{D as E}from"./DataContext-Ci3vJGAn.js";import"./index-BcpdaU_9.js";import{e as R}from"./entryName-YEbyRcwF.js";import{M as G}from"./index-BE3kuRki.js";import{r as W}from"./index-BxGZLBy8.js";import{r as N}from"./index-BX8ORmSg.js";import{L as b}from"./Link-DnkA8WvK.js";import{D as H}from"./LockDataProvider-BpwS9uGB.js";import{l as J}from"./filterFields-Dvte7zEt.js";import"./collectionStatsById-DY1NVZ7h.js";import"./useData-D2rAOi8c.js";import"./dataUrls-DkJe4Pqg.js";function K({page:s={}}){_((s==null?void 0:s.title)||"Page Not Found");const y=B(),{getEntryFromId:h}=j.useContext(E),k=r=>{y(`/locks?id=${r}`)},m=({idChildren:r,descriptions:v=[]})=>{var A,T;const I=l.Children.toArray(r).map(c=>{var f;return typeof c=="string"?c:((f=c==null?void 0:c.props)==null?void 0:f.children)??""}).flat().join("").trim(),t=h(String(I))||{},g=R(t,"any",{includeVersion:!1}),x=t!=null&&t.belt?t.belt==="Unranked"?"Unranked:":t.belt.replace(/ \d/,"")+" Belt:":"",d=(t==null?void 0:t.media)||[{}],a={color:"#ddd",textDecoration:"underline",cursor:"pointer","&:hover":{color:"#fff"}},{isMobile:o}=S(),n=o?85:150,u="1.0rem",L=o?"1.1rem":"1.2rem",P=o?"6px 16px 0px 0":"6px 24px 0px 0";return e.jsx(l.Fragment,{children:e.jsxs("div",{style:{...i,display:"flex",alignItems:"stretch",position:"relative",backgroundColor:"#222",padding:"16px 32px"},children:[e.jsx(F,{value:t==null?void 0:t.belt,style:{position:"absolute",top:0,left:0,bottom:0}}),e.jsxs("div",{style:{display:"flex",flexDirection:"column",alignItems:"stretch",position:"relative"},children:[e.jsxs("div",{style:{fontWeight:600,fontSize:L,marginBottom:8},children:[x," ",e.jsx(b,{onClick:()=>{k(t.id)},sx:a,children:g})]}),e.jsxs("div",{style:{display:"flex"},children:[!o&&((A=d[0])==null?void 0:A.thumbnailUrl)&&e.jsx("div",{style:{margin:P},children:e.jsx(b,{onClick:()=>{k(t.id)},children:e.jsx("img",{style:{width:n},src:(T=d[0])==null?void 0:T.thumbnailUrl,alt:g})})}),e.jsx("div",{children:v.map((c,f)=>e.jsx("div",{style:{marginBottom:8,fontSize:u},children:c},f))})]})]})]})})};function w({markdown:r}){const{isMobile:v}=S(),I="1.0rem";return e.jsx(G,{components:{ul:({children:t})=>{const g=o=>l.Children.toArray(o).map(n=>{var u;return typeof n=="string"?n:((u=n==null?void 0:n.props)==null?void 0:u.children)??""}).flat().join("").trim(),x=l.Children.toArray(t).filter(l.isValidElement),d=[];let a=null;return x.forEach(o=>{const n=g(o.props.children);if(!!h(String(n)))a&&d.push(a),a={idChildren:o.props.children,descriptions:[]};else{if(!a)return;a.descriptions.push(o.props.children)}}),a&&d.push(a),e.jsx(e.Fragment,{children:d.map((o,n)=>e.jsx(m,{idChildren:o.idChildren,descriptions:o.descriptions},`ld-${n}`))})},blockquote:({children:t})=>e.jsx("div",{style:{...i,fontSize:I,alignItems:"stretch",position:"relative",backgroundColor:"#2a2a2a",borderBottom:"1px solid #000",padding:"12px 18px 6px 18px"},children:t}),p:({children:t})=>e.jsx("div",{style:{marginBottom:12,lineHeight:"1.5em"},children:t}),h1:({children:t})=>e.jsx("div",{style:{...i,fontSize:"1.7rem",fontWeight:700,backgroundColor:"#2a2a2a",padding:"8px 0 0 18px",borderBottom:"none"},children:t}),h6:({children:t})=>e.jsx("div",{style:{...i,textAlign:"right",fontSize:"0.85rem",padding:"8px 8px 0 18px",borderBottom:"none"},children:t})},remarkPlugins:[N],rehypePlugins:[[W,{target:"_blank",rel:["nofollow","noopener","noreferrer"]}]],children:r})}const i={maxWidth:700,marginLeft:"auto",marginRight:"auto",padding:"6px 20px",borderBottom:"1px solid #333",borderRadius:0};return e.jsx(l.Fragment,{children:e.jsx(w,{markdown:s.content})})}const Y=`# mgsecure
...
###### *Originally published Sept. 21, 2023*`,V=`# NiXXeD
...
###### *Originally published Sept. 19, 2023*`,X=`# PeaceWeapon
...
###### *Originally published Nov. 30, 2023*`,Q=`# Dynamic
...
###### *Originally published Jan. 17, 2025*`,Z=`# Five is Binding
...
###### *Original request Mar. 11, 2023*`,p={nixxed:{content:V,title:"NiXXeD",description:"A classic pin-tumbler path to black. First of the series from lpubelts founder NiXXeD."},mgsecure:{content:Y,title:"mgsecure",description:"A path to black comprising all dimple locks from another founding member of the lpubelts team."},peace:{content:X,title:"PeaceWeapon",description:"Path to black filled with recommendations from our eloquent, if sometimes verbose, dear friend Peace."},dynamic:{content:Q,title:"Dynamic",description:"Another take with tons of recommendations from South Korean Black Belt Dynamic."},fiveisbinding:{content:Z,title:"Five is Binding",description:"Not a full path, but a *six* lock, all ASSA Twin Black Belt submission."}};function $(){const s=B(),y=M(),{pageId:h}=D.parse(y.search),k=i=>{const r=window.open(i,"_blank","noopener,noreferrer");r&&(r.opener=null)},m={maxWidth:700,marginLeft:"auto",marginRight:"auto",padding:"6px 20px",borderRadius:0},w={color:"#bbb",textDecoration:"underline",cursor:"pointer","&:hover":{color:"#fff"}};return e.jsxs("div",{style:{margin:8,paddingBottom:32,marginLeft:"auto",marginRight:"auto",marginTop:16,marginBottom:16},children:[!p[h]&&e.jsxs(l.Fragment,{children:[e.jsx("div",{style:{...m,fontSize:"1.8rem",fontWeight:700,padding:"8px 0 0 18px"},children:"Path to Black"}),e.jsxs("div",{style:m,children:[e.jsx("div",{style:{marginBottom:24},children:`We've asked advanced pickers to share their view of a "Path to Black", tracing the steps of rising through the LPU Belt Rankings. Some have shared the actual locks they submitted along the way while other have taken the opportunity to explore options around a specific theme. Most include an array of recommendations for each belt.`}),Object.keys(p).map(i=>e.jsxs("div",{style:{marginTop:16,maxWidth:500},children:[e.jsx(b,{onClick:()=>{s(`/pathtoblack?pageId=${i}`)},style:{color:"#ddd",cursor:"pointer",fontWeight:600,fontSize:"1.2rem",textDecoration:"underline"},children:p[i].title}),e.jsx("br",{}),p[i].description]},i)),e.jsxs("div",{style:{marginTop:30,borderTop:"1px solid #fff",paddingTop:16,fontSize:"0.95rem"},children:["A great source for higher-belt locks is the #lock-bazaar channel on the LPU discord. You can browse/search/filter listings from most of the major sellers at: ",e.jsx(b,{onClick:()=>k("https://lpulocks.com/#/lockbazaar"),sx:w,children:"lpulocks.com/#/lockbazaar"})]})]})]}),p[h]&&e.jsx(K,{page:p[h]})]})}function me(){_("Path To Black");const s=e.jsx(l.Fragment,{});return e.jsx(O,{filterFields:J,children:e.jsxs(H,{allEntries:U,children:[e.jsx(C,{title:"Path To Black",extras:s}),e.jsx($,{}),e.jsx(z,{}),e.jsx(q,{feature:"pathtoblack"})]})})}export{me as default};
