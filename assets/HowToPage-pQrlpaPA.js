import{r,A as s,j as e,R as i,aa as l,ab as h,as as c}from"./index-7Ema7Unt.js";/* empty css                  */import{M as d}from"./index-CLhE2ZED.js";import{r as u}from"./index-BFZUaVzW.js";import{r as p}from"./index-Dy3yIkwg.js";const y=`## Hello Black Belts!
...
`;function k(){const o="8/15/2024",{user:t}=r.useContext(s),n=t?t.uid:"(your id)",a=String(y).replace("[YourID]",n);return e.jsx(i.Fragment,{children:e.jsxs(l,{style:{maxWidth:760,marginLeft:"auto",marginRight:"auto",marginTop:16,marginBottom:16},children:[e.jsx(h,{children:e.jsx(d,{rehypePlugins:[[p,{target:"_blank"}]],remarkPlugins:[u],children:a})}),e.jsxs(c,{children:["Updated: ",o]})]})})}export{k as default};
