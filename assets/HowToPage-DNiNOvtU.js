import{Zr as e,_t as t,gt as n,pi as r,tn as i,vi as a,vt as o}from"./index-DNdmLTwU.js";import{t as s}from"./lib-DW8euZVY.js";import{t as c}from"./lib-27pnAN5m.js";import{t as l}from"./lib-DLBNm4yf.js";/* empty css                  */var u=a(r(),1),d=`## Hello Black Belts!
...
`,f=e();function p(){let{user:e}=(0,u.useContext)(i),r=e?e.uid:`(your id)`,a=String(d).replace(`[YourID]`,r);return(0,f.jsx)(u.Fragment,{children:(0,f.jsxs)(o,{style:{maxWidth:760,marginLeft:`auto`,marginRight:`auto`,marginTop:16,marginBottom:16},children:[(0,f.jsx)(n,{children:(0,f.jsx)(s,{rehypePlugins:[[c,{target:`_blank`}]],remarkPlugins:[l],children:a})}),(0,f.jsxs)(t,{children:[`Updated: `,`8/15/2024`]})]})})}export{p as default};