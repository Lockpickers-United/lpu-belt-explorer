var e={safeLocksTierOne:{title:`Tier 1 Safe/Combination Locks`,content:`## Tier 1 Safe/Combination Locks
...
- Yale V705 padlock
`},tierThreeExample:{title:`Tier 3 Submission Example`,content:`## Tier 3 Submission Example - Lady Locks
...
**Lady Locks** 
`},pinkBelts:{title:`Official Announcement: The Pink Belt Revolution!`,content:`Attention all lockpicking enthusiasts, tinkerers, and masters of the craft! We are thrilled to unveil a bold new tradition in our ranking system—from this day forward, all lockpicking belts will be shades of pink! 🎀✨
...
*Please note: we are in the process of converting everything to the new belt colors. Please be patient if we haven't gotten to everything just yet.*`},classificationProcess:{title:`Lockpickers United Belt Ranking Process`,content:`The Lockpickers United ranking process may seem opaque but it isn't a secret. It's a big job done by the community and it powers the nearly 900 locks currently on the site, more than 750 of which are ranked.
...
`},danModifiers:{title:`Dan System - Point Modifiers`,content:`There are special cases in which the Dan Point value for a lock is modified to reflect the amount of work and skill that was required to open it. Achievements below apply a multipler to the normal Dan points for the lock as ranked.
