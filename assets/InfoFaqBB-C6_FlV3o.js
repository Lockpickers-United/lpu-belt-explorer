import{r as n,A as s,j as e,R as i,aa as r,ab as l}from"./index-DMiwPlZn.js";/* empty css                  */import{M as c}from"./index-C2LIqwa8.js";import{r as h}from"./index-E-FHSyRF.js";import{r as d}from"./index-DTszTD9X.js";const u=`## Scorecard FAQ for Black Belts
...
`;function g(){const{user:t}=n.useContext(s),o=t?t.uid:"(your id)",a=String(u).replace("[YourID]",o);return e.jsx(i.Fragment,{children:e.jsx(r,{style:{maxWidth:760,marginLeft:"auto",marginRight:"auto",marginTop:16,marginBottom:16},children:e.jsx(l,{children:e.jsx(c,{rehypePlugins:[[d,{target:"_blank"}]],remarkPlugins:[h],children:a})})})})}export{g as default};
