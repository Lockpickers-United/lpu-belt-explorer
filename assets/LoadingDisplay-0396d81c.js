import{g as L,a as z,b7 as R,s as x,c as l,_ as o,b8 as D,r as I,u as N,b as U,j as t,d as B,e as E,R as F}from"./index-5aed8077.js";import{B as K}from"./Box-821e937f.js";function W(r){return z("MuiCircularProgress",r)}const G=L("MuiCircularProgress",["root","determinate","indeterminate","colorPrimary","colorSecondary","svg","circle","circleDeterminate","circleIndeterminate","circleDisableShrink"]),T=G,V=["className","color","disableShrink","size","style","thickness","value","variant"];let d=r=>r,P,b,S,$;const a=44,Z=R(P||(P=d`
  0% {
...
`)),A=r=>{const{classes:e,variant:s,color:i,disableShrink:u}=r,m={root:["root",s,`color${l(i)}`],svg:["svg"],circle:["circle",`circle${l(s)}`,u&&"circleDisableShrink"]};return E(m,W,e)},H=x("span",{name:"MuiCircularProgress",slot:"Root",overridesResolver:(r,e)=>{const{ownerState:s}=r;return[e.root,e[s.variant],e[`color${l(s.color)}`]]}})(({ownerState:r,theme:e})=>o({display:"inline-block"},r.variant==="determinate"&&{transition:e.transitions.create("transform")},r.color!=="inherit"&&{color:(e.vars||e).palette[r.color].main}),({ownerState:r})=>r.variant==="indeterminate"&&D(S||(S=d`
