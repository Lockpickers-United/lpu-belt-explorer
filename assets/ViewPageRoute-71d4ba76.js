import{ad as r,ae as h,j as e,R as a,N as c,a0 as l,a1 as d,aj as m,F as u,T as k}from"./index-bedef1ed.js";/* empty css                  */import{u as p}from"./usePageTitle-dafa1929.js";import{M as g}from"./index-cbff07fc.js";import{r as f}from"./index-2ced56bb.js";import{r as y}from"./index-1fdee365.js";import"./useDocumentTitle-8dba75d5.js";const w=`## Tier 1 Safe/Combination Locks
...
- Yale V705 padlock
`,b=`## Tier 3 Submission Example - Lady Locks
...
**Lady Locks** 
`,v=`Attention all lockpicking enthusiasts, tinkerers, and masters of the craft! We are thrilled to unveil a bold new tradition in our ranking system—from this day forward, all lockpicking belts will be shades of pink! 🎀✨
...
*Please note: we are in the process of converting everything to the new belt colors. Please be patient if we haven't gotten to everything just yet.*`,i={safeLocksTierOne:{title:"Tier 1 Safe/Combination Locks",content:w},tierThreeExample:{title:"Tier 3 Submission Example",content:b},pinkBelts:{title:"Official Announcement: The Pink Belt Revolution!",content:v}};function T(){var t,n;const s=r(),{pageId:o}=h.parse(s.search);return p(((t=i[o])==null?void 0:t.title)||"Page Not Found"),e.jsxs(a.Fragment,{children:[e.jsx(c,{title:"Information"}),e.jsxs(l,{style:{maxWidth:800,marginLeft:"auto",marginRight:"auto",marginTop:16,marginButtom:16,padding:"0px 30px"},children:[e.jsxs(d,{children:[o==="pinkBelts"&&e.jsx("div",{style:{color:"rgb(255, 102, 204)",fontSize:"1.5rem",fontWeight:700},children:"Official Announcement: The Pink Belt Revolution!"}),e.jsx(g,{rehypePlugins:[[f,{target:"_blank",rel:["nofollow","noopener","noreferrer"]}]],remarkPlugins:[y],children:((n=i[o])==null?void 0:n.content)||"Page Not Found"})]}),e.jsx(m,{})]})]})}function C(){return e.jsxs(a.Fragment,{children:[e.jsx(T,{}),e.jsx(u,{}),e.jsx(k,{feature:"viewPage"})]})}export{C as default};
