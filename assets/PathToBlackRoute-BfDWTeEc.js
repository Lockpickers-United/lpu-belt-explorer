import{b as w,r as x,j as e,R as l,ah as S,ai as T,e as B,a2 as _,N as L,h as P,T as j}from"./index-BhEcN-EE.js";import{u as v}from"./usePageTitle-3DAXpbYf.js";import{B as M}from"./BeltStripeMini-Dl_KUYV8.js";import{D}from"./DataContext-G_0FLxFP.js";import"./index-DfbB1GVg.js";import{e as O}from"./entryName-fEjgwqKu.js";import{M as C}from"./index-TgVfCXs5.js";import{r as U}from"./index-aVdg0vgb.js";import{r as E}from"./index-rrONkYcJ.js";import{L as I}from"./Link-Dojfk79r.js";import{D as F}from"./LockDataProvider-B-3yyzSa.js";import{l as G}from"./filterFields-C29Axu-W.js";import"./collectionStatsById-DY1NVZ7h.js";import"./useData-B6jM7RnZ.js";import"./dataUrls-DkJe4Pqg.js";function R({page:s={}}){v((s==null?void 0:s.title)||"Page Not Found");const b=w(),{getEntryFromId:c}=x.useContext(D),m=k=>{b(`/locks?id=${k}`)},h=({idChildren:k,descriptions:o=[]})=>{var p;const y=l.Children.toArray(k).map(r=>{var f;return typeof r=="string"?r:((f=r==null?void 0:r.props)==null?void 0:f.children)??""}).flat().join("").trim(),t=c(String(y))||{},d=O(t,"any",{includeVersion:!1}),n=t!=null&&t.belt?t.belt==="Unranked"?"Unranked":t.belt.replace(/ \d/,""):"Unknown",a=(t==null?void 0:t.media)||[{}],i={color:"#ddd",textDecoration:"underline",cursor:"pointer","&:hover":{color:"#fff"}};return e.jsx(l.Fragment,{children:e.jsxs("div",{style:{...g,display:"flex",alignItems:"stretch",position:"relative",backgroundColor:"#222",padding:"16px 32px"},children:[e.jsx(M,{value:t==null?void 0:t.belt,style:{position:"absolute",top:0,left:0,bottom:0}}),e.jsxs("div",{style:{display:"flex",flexDirection:"column",alignItems:"stretch",position:"relative"},children:[e.jsxs("div",{style:{fontWeight:600,fontSize:"1.2rem",marginBottom:8},children:[n," Belt: ",e.jsx(I,{onClick:()=>{m(t.id)},sx:i,children:d})]}),e.jsxs("div",{style:{display:"flex"},children:[e.jsx("div",{style:{margin:"6px 24px 6px 0"},children:e.jsx("img",{style:{width:150},src:(p=a[0])==null?void 0:p.thumbnailUrl,alt:d})}),e.jsx("div",{children:o.map((r,f)=>e.jsx("div",{style:{marginBottom:8},children:r},f))})]})]})]})})};function A({markdown:k}){return e.jsx(C,{components:{ul:({children:o})=>{const y=a=>l.Children.toArray(a).map(i=>{var p;return typeof i=="string"?i:((p=i==null?void 0:i.props)==null?void 0:p.children)??""}).flat().join("").trim(),t=l.Children.toArray(o).filter(l.isValidElement),d=[];let n=null;return t.forEach(a=>{const i=y(a.props.children);if(!!c(String(i)))n&&d.push(n),n={idChildren:a.props.children,descriptions:[]};else{if(!n)return;n.descriptions.push(a.props.children)}}),n&&d.push(n),e.jsx(e.Fragment,{children:d.map((a,i)=>e.jsx(h,{idChildren:a.idChildren,descriptions:a.descriptions},`ld-${i}`))})},blockquote:({children:o})=>e.jsx("div",{style:{...g,alignItems:"stretch",position:"relative",backgroundColor:"#333",borderBottom:"1px solid #000",padding:"12px 18px 6px 18px"},children:o}),p:({children:o})=>e.jsx("div",{style:{marginBottom:12,lineHeight:"1.5em"},children:o}),h1:({children:o})=>e.jsx("div",{style:{...g,fontSize:"1.7rem",fontWeight:700,backgroundColor:"#333",padding:"8px 0 0 18px"},children:o}),h6:({children:o})=>e.jsx("div",{style:{...g,textAlign:"right",fontSize:"0.85rem",padding:"8px 0 0 18px",borderBottom:"none"},children:o})},remarkPlugins:[E],rehypePlugins:[[U,{target:"_blank",rel:["nofollow","noopener","noreferrer"]}]],children:k})}const g={maxWidth:700,marginLeft:"auto",marginRight:"auto",padding:"6px 20px",borderBottom:"1px solid #333",borderRadius:0};return e.jsx(l.Fragment,{children:e.jsx(A,{markdown:s.content})})}const q=`# mgsecure
...
###### *Originally published Sept. 21, 2023*`,W=`# NiXXeD
...
###### *Originally published Sept. 19, 2023*`,N=`# PeaceWeapon
...
###### *Originally published Jan. 17, 2025*`,u={nixxed:{content:W,title:"NiXXeD",description:"A classic pin-tumbler path to black. First of the series from lpubelts founder NiXXeD."},mgsecure:{content:q,title:"mgsecure",description:"A path to black comprising all dimple locks from another founding member of the lpubelts team."},peace:{content:N,title:"PeaceWeapon",description:"Path to black filled with recommendations from our eloquent, if sometimes verbose, dear friend Peace."},dynamic:{content:z,title:"Dynamic",description:"Another take with tons of recommendations from South Korean Black Belt Dynamic."}};function H(){const s=w(),b=S(),{pageId:c}=T.parse(b.search),m={maxWidth:700,marginLeft:"auto",marginRight:"auto",padding:"6px 20px",borderRadius:0};return e.jsxs("div",{style:{margin:8,paddingBottom:32,marginLeft:"auto",marginRight:"auto",marginTop:16,marginBottom:16},children:[!u[c]&&e.jsxs(l.Fragment,{children:[e.jsx("div",{style:{...m,fontSize:"1.8rem",fontWeight:700,padding:"8px 0 0 18px"},children:"Path to Black"}),e.jsxs("div",{style:m,children:[e.jsx("div",{style:{marginBottom:24},children:`We've asked advanced pickers to share their view of a "Path to Black", tracing the steps of rising through the LPU Belt Rankings. Some have shared the actual locks they submitted along the way while other have taken the opportunity to explore options around a specific theme. Most include an array of recommendations for each belt.`}),Object.keys(u).map(h=>e.jsxs("div",{style:{marginTop:16,maxWidth:450},children:[e.jsx(I,{onClick:()=>{s(`/pathtoblack?pageId=${h}`)},style:{color:"#ddd",cursor:"pointer",fontWeight:600,fontSize:"1.2rem",textDecoration:"underline"},children:u[h].title}),e.jsx("br",{}),u[h].description]},h))]})]}),u[c]&&e.jsx(R,{page:u[c]})]})}function le(){v("Path To Black");const s=e.jsx(l.Fragment,{});return e.jsx(B,{filterFields:G,children:e.jsxs(F,{allEntries:_,children:[e.jsx(L,{title:"Path To Black",extras:s}),e.jsx(H,{}),e.jsx(P,{}),e.jsx(j,{feature:"pathtoblack"})]})})}export{le as default};
