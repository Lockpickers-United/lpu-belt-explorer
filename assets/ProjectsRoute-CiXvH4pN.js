import{b as g,r as s,F as k,j as e,R as y,aa as v,ab as w,L as b,e as T,N as j,h as x,T as P}from"./index-Dh83uZet.js";import{u as C}from"./usePageTitle-un7Xn5cd.js";/* empty css                  */import{M as l}from"./index-DKIPqkzy.js";import{r as c}from"./index-DW6m7wUD.js";import{r as d}from"./index-BFE3giFx.js";import{d as M}from"./filterFields-B6O7p00K.js";const q=`You can also nominate others to receive points through:
...
Dan Points can be earned by completing projects within the following Disciplines:`;function D(){const r=g(),{filters:a}=s.useContext(k),n=a==null?void 0:a.id,u=s.useCallback(o=>{r(`/projects?id=${o}`)},[r]),m=o=>{const i=document.getElementById(o);window.scrollTo({left:0,top:i.offsetTop-75,behavior:"smooth"})};s.useEffect(()=>{n&&document.getElementById(n)&&m(n)},[n]);const h={"Case Making Project Guidelines":"case-making-project-guidelines","Challenge Lock Making":"challenge-lock-making","Community Involvement":"community-involvement","Cutaway Making":"cutaway-making","Disc Detainer Pick Making":"disc-detainer-pick-making",Impressioning:"impressioning","Pick Making":"pick-making","Safe Lock Manipulation":"safe-lock-manipulation","Tool Making":"tool-making","Other Approved Projects":"other-approved-projects"},p=["Case Making Project Guidelines","Challenge Lock Making","Community Involvement","Cutaway Making","Disc Detainer Pick Making","Impressioning","Lock Design","Lock Manufacturing","Pick Making","Picking Instruction","Safe Lock Manipulation","Tool Making","Tool Manufacturing","Other Approved Projects"].map(o=>{const i=h[o];return e.jsx("li",{style:{marginTop:2},children:i?e.jsx(b,{onClick:()=>u(i),style:{color:"#fff",textDecorationColor:"#aaa",cursor:"pointer",fontWeight:500},children:o}):e.jsx("div",{style:{color:"#fff",fontWeight:400},children:o})},o)}),f=({content:o})=>e.jsx(l,{remarkPlugins:[c],rehypePlugins:[[d,{target:"_blank",rel:["nofollow","noopener","noreferrer"]}]],components:{h1:({node:i,...t})=>e.jsx("h1",{id:i.children[0].value.toLowerCase().replace(/ /g,"-"),...t}),h2:({node:i,...t})=>e.jsx("h2",{id:i.children[0].value.toLowerCase().replace(/ /g,"-"),...t}),h3:({node:i,...t})=>e.jsx("h3",{id:i.children[0].value.toLowerCase().replace(/ /g,"-"),...t}),h4:({node:i,...t})=>e.jsx("h4",{id:i.children[0].value.toLowerCase().replace(/ /g,"-"),...t}),h5:({node:i,...t})=>e.jsx("h5",{id:i.children[0].value.toLowerCase().replace(/ /g,"-"),...t}),h6:({node:i,...t})=>e.jsx("h6",{id:i.children[0].value.toLowerCase().replace(/ /g,"-"),...t})},children:o});return e.jsx(y.Fragment,{children:e.jsx(v,{style:{maxWidth:800,marginLeft:"auto",marginRight:"auto",marginTop:16,marginBottom:16,padding:"0px 30px"},children:e.jsxs(w,{children:[e.jsx(l,{rehypePlugins:[[d,{target:"_blank",rel:["nofollow","noopener","noreferrer"]}]],remarkPlugins:[c],children:String(L)}),e.jsx("ul",{children:p}),e.jsx(f,{content:q})]})})})}function F(){return C("Master's Projects"),e.jsxs(T,{filterFields:M,children:[e.jsx(j,{title:"Master's Projects"}),e.jsx(D,{}),e.jsx(x,{}),e.jsx(P,{feature:"projects"})]})}export{F as default};
