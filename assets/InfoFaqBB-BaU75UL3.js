import{Zr as e,gt as t,pi as n,tn as r,vi as i,vt as a}from"./index-DNdmLTwU.js";import{t as o}from"./lib-DW8euZVY.js";import{t as s}from"./lib-27pnAN5m.js";import{t as c}from"./lib-DLBNm4yf.js";/* empty css                  */var l=i(n(),1),u=`## Scorecard FAQ for Black Belts
...
`,d=e();function f(){let{user:e}=(0,l.useContext)(r),n=e?e.uid:`(your id)`,i=String(u).replace(`[YourID]`,n);return(0,d.jsx)(l.Fragment,{children:(0,d.jsx)(a,{style:{maxWidth:760,marginLeft:`auto`,marginRight:`auto`,marginTop:16,marginBottom:16},children:(0,d.jsx)(t,{children:(0,d.jsx)(o,{rehypePlugins:[[s,{target:`_blank`}]],remarkPlugins:[c],children:i})})})})}export{f as default};