import{r as n,A as s,j as e,R as i,ab as r,ac as l}from"./index-GEOLvjB9.js";/* empty css                  */import{M as c}from"./index-C8TRAweK.js";import{r as h}from"./index-zVjA1hyA.js";import{r as d}from"./index-f0oJ1UWz.js";const u=`## Scorecard FAQ for Black Belts
...
`;function g(){const{user:t}=n.useContext(s),o=t?t.uid:"(your id)",a=u.replace("[YourID]",o);return e.jsx(i.Fragment,{children:e.jsx(r,{style:{maxWidth:760,marginLeft:"auto",marginRight:"auto",marginTop:16,marginButtom:16},children:e.jsx(l,{children:e.jsx(c,{rehypePlugins:[[d,{target:"_blank"}]],remarkPlugins:[h],children:a})})})})}export{g as default};
