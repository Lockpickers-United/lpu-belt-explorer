import{Ct as e,K as t,Zr as n,c as r,gt as i,l as a,m as o,o as s,pi as c,s as l,vi as u,vt as d}from"./index-DNdmLTwU.js";import{t as f}from"./usePageTitle-CqhhOriZ.js";import{t as p}from"./lib-DW8euZVY.js";import{t as m}from"./lib-27pnAN5m.js";import{t as h}from"./filterFields-DG19F4s6.js";import{t as g}from"./lib-DLBNm4yf.js";/* empty css                  */var _=u(c(),1),v=`You can also nominate others to receive points through:
...
Dan Points can be earned by completing projects within the following Disciplines:`,b=n();function x(){let t=e(),{filters:n}=(0,_.useContext)(r),a=n?.id,s=(0,_.useCallback)(e=>{t(`/projects?id=${e}`)},[t]),c=e=>{let t=document.getElementById(e);window.scrollTo({left:0,top:t.offsetTop-75,behavior:`smooth`})};(0,_.useEffect)(()=>{a&&document.getElementById(a)&&c(a)},[a]);let l={"Case Making Project Guidelines":`case-making-project-guidelines`,"Challenge Lock Making":`challenge-lock-making`,"Community Involvement":`community-involvement`,"Cutaway Making":`cutaway-making`,"Disc Detainer Pick Making":`disc-detainer-pick-making`,Impressioning:`impressioning`,"Pick Making":`pick-making`,"Safe Lock Manipulation":`safe-lock-manipulation`,"Tool Making":`tool-making`,"Other Approved Projects":`other-approved-projects`},u=[`Case Making Project Guidelines`,`Challenge Lock Making`,`Community Involvement`,`Cutaway Making`,`Disc Detainer Pick Making`,`Impressioning`,`Lock Design`,`Lock Manufacturing`,`Pick Making`,`Picking Instruction`,`Safe Lock Manipulation`,`Tool Making`,`Tool Manufacturing`,`Other Approved Projects`].map(e=>{let t=l[e];return(0,b.jsx)(`li`,{style:{marginTop:2},children:t?(0,b.jsx)(o,{onClick:()=>s(t),style:{color:`#fff`,textDecorationColor:`#aaa`,cursor:`pointer`,fontWeight:500},children:e}):(0,b.jsx)(`div`,{style:{color:`#fff`,fontWeight:400},children:e})},e)});return(0,b.jsx)(_.Fragment,{children:(0,b.jsx)(d,{style:{maxWidth:800,marginLeft:`auto`,marginRight:`auto`,marginTop:16,marginBottom:16,padding:`0px 30px`},children:(0,b.jsxs)(i,{children:[(0,b.jsx)(p,{rehypePlugins:[[m,{target:`_blank`,rel:[`nofollow`,`noopener`,`noreferrer`]}]],remarkPlugins:[g],children:String(y)}),(0,b.jsx)(`ul`,{children:u}),(0,b.jsx)(({content:e})=>(0,b.jsx)(p,{remarkPlugins:[g],rehypePlugins:[[m,{target:`_blank`,rel:[`nofollow`,`noopener`,`noreferrer`]}]],components:{h1:({node:e,...t})=>(0,b.jsx)(`h1`,{id:e.children[0].value.toLowerCase().replace(/ /g,`-`),...t}),h2:({node:e,...t})=>(0,b.jsx)(`h2`,{id:e.children[0].value.toLowerCase().replace(/ /g,`-`),...t}),h3:({node:e,...t})=>(0,b.jsx)(`h3`,{id:e.children[0].value.toLowerCase().replace(/ /g,`-`),...t}),h4:({node:e,...t})=>(0,b.jsx)(`h4`,{id:e.children[0].value.toLowerCase().replace(/ /g,`-`),...t}),h5:({node:e,...t})=>(0,b.jsx)(`h5`,{id:e.children[0].value.toLowerCase().replace(/ /g,`-`),...t}),h6:({node:e,...t})=>(0,b.jsx)(`h6`,{id:e.children[0].value.toLowerCase().replace(/ /g,`-`),...t})},children:e}),{content:v})]})})})}function S(){return f(`Master's Projects`),(0,b.jsxs)(a,{filterFields:h,children:[(0,b.jsx)(l,{title:`Master's Projects`}),(0,b.jsx)(x,{}),(0,b.jsx)(t,{}),(0,b.jsx)(s,{feature:`projects`})]})}export{S as default};