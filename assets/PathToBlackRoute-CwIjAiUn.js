import{t as e}from"./Box-DFZe_dP7.js";import{Ct as t,Gt as n,K as r,St as i,Zr as a,k as o,l as s,m as c,o as l,pi as u,s as d,u as f,vi as p}from"./index-DNdmLTwU.js";import{t as m}from"./usePageTitle-CqhhOriZ.js";import{t as h}from"./lib-DW8euZVY.js";import{t as g}from"./lib-27pnAN5m.js";import{n as _}from"./filterFields-DG19F4s6.js";import{t as v}from"./entryName-D7Zp9Moi.js";import{t as y}from"./BeltStripeMini-dTvHU_OU.js";import{t as b}from"./lib-DLBNm4yf.js";import{n as x,t as S}from"./LockDataProvider-j9os189x.js";var C=p(u(),1),w=a();function T({page:n={}}){n?.title&&m(`Path to Black: `+n?.title);let r=t(),{getEntryFromId:i}=(0,C.useContext)(x),a=e=>{r(`/locks?id=${e}`)},o=({idChildren:e,descriptions:t=[]})=>{let n=C.Children.toArray(e).map(e=>typeof e==`string`?e:e?.props?.children??``).flat().join(``).trim(),r=i(String(n))||{},o=v(r,`any`,{includeVersion:!1}),s=r?.belt?r.belt===`Unranked`?`Unranked:`:r.belt.replace(/ \d/,``)+` Belt:`:``,l=r?.media||[{}],d={color:`#ddd`,textDecoration:`underline`,cursor:`pointer`,"&:hover":{color:`#fff`}},{isMobile:p}=f(),m=p?85:150,h=p?`1.1rem`:`1.2rem`,g=p?`6px 16px 0px 0`:`6px 24px 0px 0`;return(0,w.jsx)(C.Fragment,{children:(0,w.jsxs)(`div`,{style:{...u,display:`flex`,alignItems:`stretch`,position:`relative`,backgroundColor:`#222`,padding:`16px 32px`},children:[(0,w.jsx)(y,{value:r?.belt,style:{position:`absolute`,top:0,left:0,bottom:0}}),(0,w.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,alignItems:`stretch`,position:`relative`},children:[(0,w.jsxs)(`div`,{style:{fontWeight:600,fontSize:h,marginBottom:8},children:[s,` `,(0,w.jsx)(c,{onClick:()=>{a(r.id)},sx:d,children:o})]}),(0,w.jsxs)(`div`,{style:{display:`flex`},children:[!p&&l[0]?.thumbnailUrl&&(0,w.jsx)(`div`,{style:{margin:g},children:(0,w.jsx)(c,{onClick:()=>{a(r.id)},children:(0,w.jsx)(`img`,{style:{width:m},src:l[0]?.thumbnailUrl,alt:o})})}),(0,w.jsx)(`div`,{children:t.map((e,t)=>(0,w.jsx)(`div`,{style:{marginBottom:8,fontSize:`1.0rem`},children:e},t))})]})]})]})})},s=({idChildren:e,descriptions:t=[]})=>{let n=C.Children.toArray(e).map(e=>typeof e==`string`?e:e?.props?.children??``).flat().join(``).trim(),r=i(String(n))||{},{isMobile:a}=f();return(0,w.jsx)(C.Fragment,{children:(0,w.jsxs)(`div`,{style:{...u,display:`flex`,alignItems:`stretch`,position:`relative`,backgroundColor:`#222`,padding:`16px 32px`},children:[(0,w.jsx)(y,{value:r?.belt,style:{position:`absolute`,top:0,left:0,bottom:0}}),(0,w.jsx)(`div`,{style:{display:`flex`,flexDirection:`column`,alignItems:`stretch`,position:`relative`},children:(0,w.jsx)(`div`,{style:{display:`flex`},children:(0,w.jsx)(`div`,{children:t.map((e,t)=>(0,w.jsx)(`div`,{style:{marginBottom:8,fontSize:`1.0rem`},children:e},t))})})})]})})};function l({markdown:t}){let{isMobile:n}=f(),a=n?`1.5rem`:`1.7rem`,l={fontWeight:400,color:`#888`,textDecoration:`none`,cursor:`pointer`,"&:hover":{textDecoration:`underline`,color:`#fff`}};return(0,w.jsx)(h,{components:{ul:({children:e})=>{let t=e=>C.Children.toArray(e).map(e=>typeof e==`string`?e:e?.props?.children??``).flat().join(``).trim(),n=C.Children.toArray(e).filter(C.isValidElement),r=[],a=null;return n.forEach(e=>{let n=t(e.props.children);if(i(String(n)))a&&r.push(a),a={idChildren:e.props.children,descriptions:[]};else{if(!a)return;a.descriptions.push(e.props.children)}}),a&&r.push(a),(0,w.jsx)(w.Fragment,{children:r.map((e,t)=>(0,w.jsx)(o,{idChildren:e.idChildren,descriptions:e.descriptions},`ld-${t}`))})},ol:({children:e})=>{let t=e=>C.Children.toArray(e).map(e=>typeof e==`string`?e:e?.props?.children??``).flat().join(``).trim(),n=C.Children.toArray(e).filter(C.isValidElement),r=[],a=null;return n.forEach(e=>{let n=t(e.props.children);if(i(String(n)))a&&r.push(a),a={idChildren:e.props.children,descriptions:[]};else{if(!a)return;a.descriptions.push(e.props.children)}}),a&&r.push(a),(0,w.jsx)(w.Fragment,{children:r.map((e,t)=>(0,w.jsx)(s,{idChildren:e.idChildren,descriptions:e.descriptions},`ld-${t}`))})},blockquote:({children:e})=>(0,w.jsx)(`div`,{style:{...u,fontSize:`1.0rem`,alignItems:`stretch`,position:`relative`,backgroundColor:`#2a2a2a`,borderBottom:`1px solid #000`,padding:`12px 18px 6px 18px`},children:e}),p:({children:e})=>(0,w.jsx)(`div`,{style:{marginBottom:12,lineHeight:`1.5em`},children:e}),h1:({children:t})=>(0,w.jsxs)(`div`,{style:{...u,fontSize:a,fontWeight:700,backgroundColor:`#2a2a2a`,padding:`8px 0 0 18px`,borderBottom:`none`},children:[(0,w.jsxs)(e,{component:`span`,style:{fontWeight:400,color:`#666`,fontSize:`1.2rem`},children:[(0,w.jsx)(c,{sx:l,onClick:()=>{r(`/pathtoblack`)},children:`path to black`}),` > `]}),(0,w.jsx)(`nobr`,{children:t})]}),h6:({children:e})=>(0,w.jsx)(`div`,{style:{...u,textAlign:`right`,fontSize:`0.85rem`,padding:`8px 8px 0 18px`,borderBottom:`none`},children:e})},remarkPlugins:[b],rehypePlugins:[[g,{target:`_blank`,rel:[`nofollow`,`noopener`,`noreferrer`]}]],children:t})}let u={maxWidth:700,marginLeft:`auto`,marginRight:`auto`,padding:`6px 20px`,borderBottom:`1px solid #333`,borderRadius:0};return(0,w.jsx)(`div`,{style:{margin:6},children:(0,w.jsx)(l,{markdown:n.content})})}var E={nixxed:{content:`# NiXXeD
...
`,title:`TonySanSan`,description:`LPU guru TonySanSan takes us on a journey, not just to Black Belt, but to the Kromer Protector -- one of the most difficult locks in the world.`}};function D(){let e=t(),n=i(),{pageId:r}=o.parse(n.search),a=e=>{let t=window.open(e,`_blank`,`noopener,noreferrer`);t&&(t.opener=null)},s={maxWidth:700,marginLeft:`auto`,marginRight:`auto`,padding:`6px 20px`,borderRadius:0},l={color:`#eee`,textDecoration:`underline`,cursor:`pointer`,"&:hover":{color:`#fff`,textDecoration:`underline`}};return(0,w.jsxs)(`div`,{style:{margin:8,paddingBottom:32,marginLeft:`auto`,marginRight:`auto`,marginTop:16,marginBottom:16},children:[!E[r]&&(0,w.jsx)(C.Fragment,{children:(0,w.jsxs)(`div`,{style:s,children:[(0,w.jsx)(`div`,{style:{marginBottom:24},children:`We've asked advanced pickers to share their view of a "Path to Black", tracing the steps of rising through the LPU Belt Rankings. Some have shared the actual locks they submitted along the way while other have taken the opportunity to explore options around a specific theme. Most include an array of recommendations for each belt.`}),Object.keys(E).map(t=>(0,w.jsxs)(`div`,{style:{marginTop:16,maxWidth:650},children:[(0,w.jsx)(c,{onClick:()=>{e(`/pathtoblack?pageId=${t}`)},style:{fontWeight:600,fontSize:`1.1rem`},sx:l,children:E[t].title}),(0,w.jsx)(`br`,{}),E[t].description]},t)),(0,w.jsxs)(`div`,{style:{marginTop:30,borderTop:`1px solid #fff`,paddingTop:16,fontSize:`0.95rem`},children:[`A great source for higher-belt locks is the #lock-bazaar channel on the LPU discord. You can browse/search/filter listings from most of the major sellers at: `,(0,w.jsx)(c,{onClick:()=>a(`https://lpulocks.com/#/lockbazaar`),sx:l,children:`lpulocks.com/#/lockbazaar`})]})]})}),E[r]&&(0,w.jsx)(T,{page:E[r]})]})}function O(){return m(`Path To Black`),(0,w.jsx)(s,{filterFields:_,children:(0,w.jsxs)(S,{allEntries:n,children:[(0,w.jsx)(d,{title:`Path To Black`,extras:(0,w.jsx)(C.Fragment,{})}),(0,w.jsx)(D,{}),(0,w.jsx)(r,{}),(0,w.jsx)(l,{feature:`pathtoblack`})]})})}export{O as default};