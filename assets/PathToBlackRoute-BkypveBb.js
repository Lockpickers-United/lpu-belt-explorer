import{a as e}from"./rolldown-runtime-B0Z9INg1.js";import{ot as t,q as n}from"./utils-BBPQSqcU.js";import{t as r}from"./Box-DovfbPPt.js";import{t as i}from"./Nav-D2xbLlwx.js";import{x as a}from"./DBContext-CTaQhoMz.js";import{o,s}from"./chunk-OB3PAWPO-CPAqtvhR.js";import{t as c}from"./Footer-PF8mnIDx.js";import{t as l}from"./query-string-CVHwI1on.js";import{t as u}from"./Link-ufojjnK9.js";import{t as d}from"./useWindowSize-DwFTeGdJ.js";import{n as f}from"./FilterContext-B_sM3kUO.js";import{t as p}from"./Tracker-CVM8-_qF.js";import{t as m}from"./usePageTitle-C76MYlQv.js";import{t as h}from"./lib-B0vP4FHO.js";import{t as g}from"./lib-DbE6SaL9.js";import{n as _}from"./filterFields-Cp508ylf.js";import{t as v}from"./entryName-z5XBFQ1C.js";import{t as y}from"./BeltStripeMini-BqbWC78u.js";import{t as b}from"./lib-Bq6O4Dg4.js";import{n as x,t as S}from"./LockDataProvider-CiOY-U7Y.js";var C=e(t(),1),w=n();function T({page:e={}}){e?.title&&m(`Path to Black: `+e?.title);let t=s(),{getEntryFromId:n}=(0,C.useContext)(x),i=e=>{t(`/locks?id=${e}`)},a=({idChildren:e,descriptions:t=[]})=>{let r=C.Children.toArray(e).map(e=>typeof e==`string`?e:e?.props?.children??``).flat().join(``).trim(),a=n(String(r))||{},o=v(a,`any`,{includeVersion:!1}),s=a?.belt?a.belt===`Unranked`?`Unranked:`:a.belt.replace(/ \d/,``)+` Belt:`:``,c=a?.media||[{}],f={color:`#ddd`,textDecoration:`underline`,cursor:`pointer`,"&:hover":{color:`#fff`}},{isMobile:p}=d(),m=p?85:150,h=p?`1.1rem`:`1.2rem`,g=p?`6px 16px 0px 0`:`6px 24px 0px 0`;return(0,w.jsx)(C.Fragment,{children:(0,w.jsxs)(`div`,{style:{...l,display:`flex`,alignItems:`stretch`,position:`relative`,backgroundColor:`#222`,padding:`16px 32px`},children:[(0,w.jsx)(y,{value:a?.belt,style:{position:`absolute`,top:0,left:0,bottom:0}}),(0,w.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,alignItems:`stretch`,position:`relative`},children:[(0,w.jsxs)(`div`,{style:{fontWeight:600,fontSize:h,marginBottom:8},children:[s,` `,(0,w.jsx)(u,{onClick:()=>{i(a.id)},sx:f,children:o})]}),(0,w.jsxs)(`div`,{style:{display:`flex`},children:[!p&&c[0]?.thumbnailUrl&&(0,w.jsx)(`div`,{style:{margin:g},children:(0,w.jsx)(u,{onClick:()=>{i(a.id)},children:(0,w.jsx)(`img`,{style:{width:m},src:c[0]?.thumbnailUrl,alt:o})})}),(0,w.jsx)(`div`,{children:t.map((e,t)=>(0,w.jsx)(`div`,{style:{marginBottom:8,fontSize:`1.0rem`},children:e},t))})]})]})]})})},o=({idChildren:e,descriptions:t=[]})=>{let r=C.Children.toArray(e).map(e=>typeof e==`string`?e:e?.props?.children??``).flat().join(``).trim(),i=n(String(r))||{},{isMobile:a}=d();return(0,w.jsx)(C.Fragment,{children:(0,w.jsxs)(`div`,{style:{...l,display:`flex`,alignItems:`stretch`,position:`relative`,backgroundColor:`#222`,padding:`16px 32px`},children:[(0,w.jsx)(y,{value:i?.belt,style:{position:`absolute`,top:0,left:0,bottom:0}}),(0,w.jsx)(`div`,{style:{display:`flex`,flexDirection:`column`,alignItems:`stretch`,position:`relative`},children:(0,w.jsx)(`div`,{style:{display:`flex`},children:(0,w.jsx)(`div`,{children:t.map((e,t)=>(0,w.jsx)(`div`,{style:{marginBottom:8,fontSize:`1.0rem`},children:e},t))})})})]})})};function c({markdown:e}){let{isMobile:i}=d(),s=i?`1.5rem`:`1.7rem`,c={fontWeight:400,color:`#888`,textDecoration:`none`,cursor:`pointer`,"&:hover":{textDecoration:`underline`,color:`#fff`}};return(0,w.jsx)(h,{components:{ul:({children:e})=>{let t=e=>C.Children.toArray(e).map(e=>typeof e==`string`?e:e?.props?.children??``).flat().join(``).trim(),r=C.Children.toArray(e).filter(C.isValidElement),i=[],o=null;return r.forEach(e=>{let r=t(e.props.children);if(n(String(r)))o&&i.push(o),o={idChildren:e.props.children,descriptions:[]};else{if(!o)return;o.descriptions.push(e.props.children)}}),o&&i.push(o),(0,w.jsx)(w.Fragment,{children:i.map((e,t)=>(0,w.jsx)(a,{idChildren:e.idChildren,descriptions:e.descriptions},`ld-${t}`))})},ol:({children:e})=>{let t=e=>C.Children.toArray(e).map(e=>typeof e==`string`?e:e?.props?.children??``).flat().join(``).trim(),r=C.Children.toArray(e).filter(C.isValidElement),i=[],a=null;return r.forEach(e=>{let r=t(e.props.children);if(n(String(r)))a&&i.push(a),a={idChildren:e.props.children,descriptions:[]};else{if(!a)return;a.descriptions.push(e.props.children)}}),a&&i.push(a),(0,w.jsx)(w.Fragment,{children:i.map((e,t)=>(0,w.jsx)(o,{idChildren:e.idChildren,descriptions:e.descriptions},`ld-${t}`))})},blockquote:({children:e})=>(0,w.jsx)(`div`,{style:{...l,fontSize:`1.0rem`,alignItems:`stretch`,position:`relative`,backgroundColor:`#2a2a2a`,borderBottom:`1px solid #000`,padding:`12px 18px 6px 18px`},children:e}),p:({children:e})=>(0,w.jsx)(`div`,{style:{marginBottom:12,lineHeight:`1.5em`},children:e}),h1:({children:e})=>(0,w.jsxs)(`div`,{style:{...l,fontSize:s,fontWeight:700,backgroundColor:`#2a2a2a`,padding:`8px 0 0 18px`,borderBottom:`none`},children:[(0,w.jsxs)(r,{component:`span`,style:{fontWeight:400,color:`#666`,fontSize:`1.2rem`},children:[(0,w.jsx)(u,{sx:c,onClick:()=>{t(`/pathtoblack`)},children:`path to black`}),` > `]}),(0,w.jsx)(`nobr`,{children:e})]}),h6:({children:e})=>(0,w.jsx)(`div`,{style:{...l,textAlign:`right`,fontSize:`0.85rem`,padding:`8px 8px 0 18px`,borderBottom:`none`},children:e})},remarkPlugins:[b],rehypePlugins:[[g,{target:`_blank`,rel:[`nofollow`,`noopener`,`noreferrer`]}]],children:e})}let l={maxWidth:700,marginLeft:`auto`,marginRight:`auto`,padding:`6px 20px`,borderBottom:`1px solid #333`,borderRadius:0};return(0,w.jsx)(`div`,{style:{margin:6},children:(0,w.jsx)(c,{markdown:e.content})})}var E={nixxed:{content:`# NiXXeD
...
###### *Originally published Sept. 19, 2023*`,title:`NiXXeD`,description:`A classic pin-tumbler path to black. First of the series from lpubelts founder NiXXeD.`},mgsecure:{content:`# mgsecure
...
###### *Originally published Sept. 21, 2023*`,title:`mgsecure`,description:`A path to black comprising all dimple locks from another founding member of the lpubelts team.`},peace:{content:`# PeaceWeapon
...
###### *Originally published Nov. 30, 2023*`,title:`PeaceWeapon`,description:`Path to black filled with recommendations from our eloquent, if sometimes verbose, dear friend Peace.`},dynamic:{content:`# Dynamic
...
###### *Originally published Jan. 17, 2025*`,title:`Dynamic`,description:`Another take with tons of recommendations from South Korean Black Belt Dynamic.`},fiveisbinding:{content:`# Five is Binding
...
###### *Original request Mar. 11, 2023*`,title:`Five is Binding`,description:`Not a full path, but a *six* lock, all ASSA Twin Black Belt submission.`},skylerminer:{content:`# SkylerMiner
...
`,title:`SkylerMiner`,description:`Lots of details from their zippy path to Black Belt.`},tonysansan:{content:`# TonySanSan
...
`,title:`TonySanSan`,description:`LPU guru TonySanSan takes us on a journey, not just to Black Belt, but to the Kromer Protector -- one of the most difficult locks in the world.`}};function D(){let e=s(),t=o(),{pageId:n}=l.parse(t.search),r=e=>{let t=window.open(e,`_blank`,`noopener,noreferrer`);t&&(t.opener=null)},i={maxWidth:700,marginLeft:`auto`,marginRight:`auto`,padding:`6px 20px`,borderRadius:0},a={color:`#eee`,textDecoration:`underline`,cursor:`pointer`,"&:hover":{color:`#fff`,textDecoration:`underline`}};return(0,w.jsxs)(`div`,{style:{margin:8,paddingBottom:32,marginLeft:`auto`,marginRight:`auto`,marginTop:16,marginBottom:16},children:[!E[n]&&(0,w.jsx)(C.Fragment,{children:(0,w.jsxs)(`div`,{style:i,children:[(0,w.jsx)(`div`,{style:{marginBottom:24},children:`We've asked advanced pickers to share their view of a "Path to Black", tracing the steps of rising through the LPU Belt Rankings. Some have shared the actual locks they submitted along the way while other have taken the opportunity to explore options around a specific theme. Most include an array of recommendations for each belt.`}),Object.keys(E).map(t=>(0,w.jsxs)(`div`,{style:{marginTop:16,maxWidth:650},children:[(0,w.jsx)(u,{onClick:()=>{e(`/pathtoblack?pageId=${t}`)},style:{fontWeight:600,fontSize:`1.1rem`},sx:a,children:E[t].title}),(0,w.jsx)(`br`,{}),E[t].description]},t)),(0,w.jsxs)(`div`,{style:{marginTop:30,borderTop:`1px solid #fff`,paddingTop:16,fontSize:`0.95rem`},children:[`A great source for higher-belt locks is the #lock-bazaar channel on the LPU discord. You can browse/search/filter listings from most of the major sellers at: `,(0,w.jsx)(u,{onClick:()=>r(`https://lpulocks.com/#/lockbazaar`),sx:a,children:`lpulocks.com/#/lockbazaar`})]})]})}),E[n]&&(0,w.jsx)(T,{page:E[n]})]})}function O(){m(`Path To Black`);let e=(0,w.jsx)(C.Fragment,{});return(0,w.jsx)(f,{filterFields:_,children:(0,w.jsxs)(S,{allEntries:a,children:[(0,w.jsx)(i,{title:`Path To Black`,extras:e}),(0,w.jsx)(D,{}),(0,w.jsx)(c,{}),(0,w.jsx)(p,{feature:`pathtoblack`})]})})}export{O as default};