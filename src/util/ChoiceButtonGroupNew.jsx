...
// TODO: combine with / replace ChoiceButtonGroup


export default function ChoiceButtonGroupNew({options, onChange, defaultValue, rounded, small = false, style={}, buttonStyle={}}) {
    ...
    const buttonPaddingStyle = small
        ? {padding: '1px 10px'}
        : {padding: '4px 12px'}

    buttonStyle = {...buttonStyle, ...buttonPaddingStyle}
