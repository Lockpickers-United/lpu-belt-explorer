...
import FilterByField from '../filters/FilterByField.jsx'
...
import VideocamOutlinedIcon from "@mui/icons-material/VideocamOutlined.js"
import SavingsOutlinedIcon from "@mui/icons-material/SavingsOutlined.js"
    ...
    return (
        <React.Fragment>
            ...
            >
                ...
                <Toolbar variant='dense' sx={{textAlign:'center', display:'flex', justifyContent: 'flex-end', marginRight:2}}>
                    <Button
                        variant='outlined'
                        color='inherit'
                        onClick={closeDrawer}
